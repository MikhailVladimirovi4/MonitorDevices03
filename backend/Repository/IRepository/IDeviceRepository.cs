...
namespace backend.Repository.IRepository
{
    public interface IDeviceRepository
    {
        ...
        Task<string> Update(string ipAddress, string ContractId, string address, string macAddress, string note, CancellationToken ct);
        Task<Guid> AddLogEntry(Guid id, string text, CancellationToken ct);
        Task<Guid> UpdateConected(Guid id, CancellationToken ct);
    }
}
